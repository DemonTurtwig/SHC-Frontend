      ...
      <View style={styles.body}>
        ...
        <ScrollView horizontal contentContainerStyle={styles.cardContainer} showsHorizontalScrollIndicator={false}>
          <TouchableOpacity style={styles.card} onPress={handleSelectAircon}>
            <Image source={require('./asset/icons/aircon.png')} style={styles.cardIcon} />
            <Text style={styles.cardText}>에어컨</Text>
          </TouchableOpacity>

          <View style={[styles.card, styles.disabledCard]}>
            <Image source={require('./asset/icons/television.png')} style={styles.cardIcon} />
            <Text style={styles.cardText}>TV(준비중)</Text>
          </View>

          <View style={[styles.card, styles.disabledCard]}>
            <Image source={require('./asset/icons/refrigerator.png')} style={styles.cardIcon} />
            <Text style={styles.cardText}>냉장고(준비중)</Text>
          </View>

          <View style={[styles.card, styles.disabledCard]}>
            <Image source={require('./asset/icons/washingmachine.png')} style={styles.cardIcon} />
            <Text style={styles.cardText}>세탁기(준비중)</Text>
          </View>
        </ScrollView>
      </View>
    </LinearGradient>
