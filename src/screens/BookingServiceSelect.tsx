...
const serviceTypeIcons: Record<string, any> = {
  clean:    require('./asset/icons/aircon-washing.png'),
  install: require('./asset/icons/aircon-installation.png'),
  fix:     require('./asset/icons/aircon-repair.png'),
  sell:    require('./asset/icons/aircon-sell.png'),
};
