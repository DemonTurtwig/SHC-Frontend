  ...
  return (
    <LinearGradient colors={['#d0eaff', '#89c4f4']} style={styles.wrapper}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.container}>
          <View style={styles.header}>
            <Image source={require('.././asset/icons/intro-logo.png')} style={styles.logo} />
          ...
          <View style={styles.cardRow}>
            <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('AdminUsers')}>
              <Image source={require('.././asset/icons/user.png')} style={styles.cardIcon} />
              <Text style={styles.cardText}>유저 관리</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('AdminBookings')}>
              <Image source={require('.././asset/icons/view-order.png')} style={styles.cardIcon} />
          ...
          <View style={styles.cardRow}>
            <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('AdminSettings')}>
              <Image source={require('.././asset/icons/settings.png')} style={styles.cardIcon} />
      ...
      <View style={styles.footer}>
        ...
        >
          <Image source={require('.././asset/icons/home.png')} style={[styles.footerIcon, styles.activeIcon]} />
        ...
        >
          <Image source={require('.././asset/icons/user.png')} style={styles.footerIcon} />
